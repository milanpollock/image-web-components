...
@Component({
  tag: 'drp-slide-gallery',
  styleUrl: 'drp-slide-gallery.css',
  shadow: true,
})
export class DrpSlideGallery {
  observer: any;
  ...
  @State() imagesArray: DrpSlideGalleryImage[] = [];
      ...
      <Host>
        <div class="image-gallery">
          <div class="image-gallery-content">
            <div
              ref={el => (this.gallerySlideWrapperEl = el)}
